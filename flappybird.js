...
//pipes
let pipeArray = [];
let pipeWidth = 85; //width/height ratio = 384/3072 = 1/8
let pipeHeight = 512;
...
function update() {
    ...
    if (gameOver) {
        ...
        context.font="50px Londrina Solid";
        context.fillStyle ="orange"
        context.fillText(score, boardWidth/2, boardHeight/2 + 60);
...
function placePipes() {
    ...
    let openingSpace = board.height/2.4;
